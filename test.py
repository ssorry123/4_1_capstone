...
def generate_text(text):
    ...
    '''
    outputs=model.generate(input_ids=input_ids,max_length=50, eos_token_ids=-1, repetition_penalty=1.2, do_sample=True, num_return_sequences=1)
    for i in range(1): 
